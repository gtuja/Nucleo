...
#ifndef __PATCH_240211SEO
  return (((int32_t)ipsr < ((int32_t)SVCall_IRQn + 16)) &&
          ((int32_t)ipsr > ((int32_t)NonMaskableInt_IRQn + 16)));
#else /* changed blow for compilation 240211SEO */
  return (((int32_t)ipsr < ((int32_t)SVC_IRQn + 16)) &&
          ((int32_t)ipsr > ((int32_t)NonMaskableInt_IRQn + 16)));
#endif /* __PATCH_240211SEO */
}
...
#else /* changed blow for compilation 240211SEO */
  return ((int32_t)__get_IPSR() == ((int32_t)SVC_IRQn + 16));
#endif /* __PATCH_240211SEO */
}
